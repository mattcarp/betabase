  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white font-mono p-8">
      ...
      <div className="text-center mb-8">
        <h1 className="mac-heading text-4xl font-bold text-holographic mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        <div className="glass-panel p-6 space-y-6">
          <h2 className="mac-heading text-xl font-bold text-jarvis-accent border-b border-jarvis-primary/30 pb-2">
        ...
        <div className="lg:col-span-2 xl:col-span-3">
          <div className="glass-panel p-6 space-y-6">
            <h2 className="mac-heading text-xl font-bold text-jarvis-accent border-b border-jarvis-primary/30 pb-2 text-center">
