...
export class AomaStageAuthenticator {
  ...
  private filterCookiesForDomain(cookies: PlaywrightCookie[], targetUrl: string): PlaywrightCookie[] {
  ...
  private runNodeScript(scriptPath: string, args: string[] = [], env?: NodeJS.ProcessEnv): Promise<{ ok: boolean; stdout: string; stderr: string }> {
