const SONY_JIRA_BASE = (process.env.JIRA_BASE_URL || 'https://jira.smedigitalapps.com/jira').replace(/\/$/, '');
const SONY_CONFLUENCE_BASE = (process.env.CONFLUENCE_BASE_URL || 'https://wiki.smedigitalapps.com').replace(/\/$/, '');
