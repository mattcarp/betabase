      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center">
        <div className="bg-gray-800/50 p-8 rounded-lg backdrop-blur-sm border border-gray-700">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-white mb-2">SIAM</h1>
            <p className="text-gray-300">Smart Interaction Agent Manager</p>
          </div>
          ...
          {process.env.NODE_ENV === "development" && (
            <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded text-blue-200 text-xs">
    ...
    <div className="min-h-screen bg-black text-white">
      <nav className="bg-gray-900 p-4">
        <div className="flex justify-between items-center">
          <h1 className="text-xl font-bold">SIAM Dashboard</h1>
          <button
      ...
      <main className="p-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4">Welcome to SIAM</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg backdrop-blur-sm border border-gray-700">
              ...
              <p className="text-blue-400">Production ready</p>
            </div>

            <div className="bg-gray-800/50 p-6 rounded-lg backdrop-blur-sm border border-gray-700">
              <h3 className="text-xl font-semibold mb-3">⚡ Performance</h3>
              <p className="text-yellow-400">Optimized for speed</p>
            </div>
          </div>
