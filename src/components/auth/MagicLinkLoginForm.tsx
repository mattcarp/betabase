      ...
      <div className="text-center">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center justify-center mb-6">
            <SiamLogo size="lg" variant="icon" className="drop-shadow-2xl" />
          </div>
            ...
            >
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="text"
                  placeholder="000000"
                  className="mac-input h-12 text-center text-2xl tracking-[0.5em] font-mono border-2 border-gray-600 bg-gray-800/50 backdrop-blur-sm focus:border-green-400 focus:bg-gray-800/70 transition-all duration-200"
                  disabled={isLoading}
                  maxLength={6}
