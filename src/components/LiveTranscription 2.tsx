...
export default function LiveTranscription({
  ...
  const getWordConfidence = () => {
    ...
    if (confidence > 0.85) return "text-cyan-400";
          ...
          {displayedText ? (
            ...
            <div className="flex items-center justify-center h-full text-gray-500">
              <div className="text-center">
                <div className="w-12 h-12 border-2 border-gray-600 border-t-cyan-400 rounded-full animate-spin mx-auto mb-4"></div>
