    ...
    return (
      <div className={`conversational-ai-panel ${className}`}>
        ...
        <div className="transcription-display">
          <h4 className="text-sm font-medium text-cyan-400 mb-2">Live Transcription:</h4>
          <div className="p-3 bg-gray-900/50 border border-cyan-500/30 rounded-lg min-h-[100px]">
