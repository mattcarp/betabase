...
export function SettingsPanel({ isOpen, onClose }: SettingsPanelProps) {
  ...
  return (
    ...
    >
      <div className="bg-gray-800 border border-cyan-400 rounded-lg w-full max-w-4xl h-[80vh] flex flex-col">
        {/* Header */}
        ...
        <div className="p-4 border-t border-gray-700 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleSave}
              className="flex items-center gap-2 px-4 py-2 bg-cyan-600/20 border border-cyan-500 text-cyan-300 rounded font-mono text-sm hover:bg-cyan-600/30 transition-colors"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <select
            ...
            className="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white focus:border-cyan-400 focus:outline-none"
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <input
            ...
            className="w-full h-3 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-cyan-500 slider"
            data-testid="transparency-slider"
            style={{
              background: `linear-gradient(to right, #00ffff 0%, #00ffff ${settings.windowOpacity}%, #374151 ${settings.windowOpacity}%, #374151 100%)`,
            }}
          />
          <span className="font-mono text-sm text-cyan-300 w-12 text-center">
            {settings.windowOpacity}%
          </span>
        </div>
        {isElectron ? (
        ...
        {shortcuts.map(({ key, label }) => (
          <div key={key} className="flex items-center justify-between">
            ...
            <input
              ...
              className="w-24 bg-gray-700 border border-gray-600 rounded px-2 py-1 text-white text-center font-mono text-sm focus:border-cyan-400 focus:outline-none"
