      ...
      <CardContent className="flex-1 flex flex-col gap-3 overflow-hidden">
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            <Button variant="outline" size="sm" className="text-xs" aria-label="Source filter">
              <Filter className="h-3 w-3 mr-1" /> {sourceFilter}
            </Button>
            <div className="absolute z-20 mt-1 w-48 bg-popover border rounded-md shadow-lg overflow-hidden">
          ...
          <Button
            ...
            className="text-xs"
          >
            <Zap className="h-3 w-3 mr-1" /> Rapid
          </Button>
          <Button
            size="sm"
            ...
            className="text-xs"
          >
            <Target className="h-3 w-3 mr-1" /> Focused
          </Button>
          <Button
            size="sm"
            ...
            className="text-xs"
          >
            <ListChecks className="h-3 w-3 mr-1" /> Comprehensive
          </Button>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {resp.results.map((r, idx) => (
                      <div
                        key={(r.id || idx) + "-row"}
                        className="p-3 rounded-md border hover:bg-muted/40 transition-colors"
          ...
          <TabsContent value="suggestions" className="flex-1 overflow-hidden mt-3">
