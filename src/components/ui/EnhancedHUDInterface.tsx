...
export const EnhancedHUDInterface: React.FC<EnhancedHUDInterfaceProps> = ({
  ...
  useEffect(() => {
    ...
    const themeColors = {
      ...
      purple: { primary: "#26c6da", accent: "#C77DFF" },
          ...
          {panel.id === "panel-2" && (
            <div className="w-72">
              {(panel.content as string[]).map((insight, idx) => (
                <div
                  key={idx}
                  className="mb-2 p-4 rounded-lg border-l-2 border-mac-accent-primary-400 bg-mac-accent-primary-400/10"
                >
          ...
          {panel.id === "panel-3" && (
            <div className="w-64">
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      background:
                        "linear-gradient(90deg, var(--mac-primary-blue-400), var(--mac-accent-primary-400))",
                    }}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="p-2 rounded text-center bg-mac-accent-primary-400/10">
