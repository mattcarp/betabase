...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  <div className="relative p-4 rounded-xl border border-mac-border bg-mac-surface-elevated/50 hover:bg-mac-surface-elevated transition-all duration-300 group">
    {status === "coming-soon" && (
      <Badge className="absolute -top-2 -right-2 text-xs bg-mac-accent-primary-400/20 text-mac-accent-primary-400 border-mac-accent-primary-400/30">
        Coming Soon
      </Badge>
    )}
    ...
    <div className={cn("relative w-full h-full overflow-auto mac-background p-8", className)}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="mac-heading">Heads-Up Display</h1>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <p className="mac-body font-normal text-mac-text-primary">MC-SIAM API Server</p>
        ...
        {/* Features Grid */}
        <div>
          <h2 className="mac-heading">Features</h2>
        ...
        <Card className="mac-card-elevated border-mac-border">
          <CardHeader className="mac-card">
            ...
            <CardDescription className="mac-card">Control the HUD without touching your mouse</CardDescription>
          </CardHeader>
          ...
          <CardContent className="mac-card">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center space-y-2">
                ...
                <h3 className="mac-title">Capture</h3>
                <p className="text-sm text-mac-text-secondary">
              ...
              <div className="text-center space-y-2">
                ...
                <h3 className="mac-title">Process</h3>
                <p className="text-sm text-mac-text-secondary">
              ...
              <div className="text-center space-y-2">
                ...
                <h3 className="mac-title">Display</h3>
                <p className="text-sm text-mac-text-secondary">
