...
const ResultCard: React.FC<{
  ...
  return (
    <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 rounded-lg p-5 border border-gray-700/50 hover:border-gray-600/50 transition-all duration-200 group">
      {/* Header */}
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1 px-2 py-1 bg-blue-600/20 rounded-full border border-blue-500/30">
    ...
    <div className="bg-gradient-to-br from-gray-800/90 to-gray-900/90 rounded-xl p-6 border border-gray-700/50 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-gray-800/50 rounded-lg p-3">
          <div className="text-xs text-gray-400 mb-1">Search Method</div>
          <div className="flex items-center gap-2">
        ...
        <div className="bg-gray-800/50 rounded-lg p-3">
          <div className="text-xs text-gray-400 mb-1">Results Shown</div>
        ...
        <div className="bg-gray-900/50 rounded-lg p-4">
          ...
          <div className="flex flex-wrap gap-2">
            {data.suggestions.map((suggestion, index) => (
              <button
                key={index}
                className="px-3 py-2 bg-gray-700/50 hover:bg-gray-700 text-gray-300 rounded-lg text-sm transition-colors"
              >
                {suggestion}
              </button>
            ))}
