...
export function HUDLayout({
  ...
  const renderActivePanel = () => {
    switch (activePanel) {
      case "audio":
        return (
          <div className="glass-panel p-6 w-80 h-80 flex flex-col items-center justify-center animate-pulse-slow">
            <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-lg animate-gradient-xy"></div>
            <h3 className="text-holographic text-lg mb-4 font-mono tracking-wider">
              <span className="animate-glow">AUDIO VISUALIZATION</span>
            </h3>
            <AudioWaveform
              isRecording={isRecording}
              className="w-full h-32 border border-cyan-500/30 rounded-lg p-2"
            />
      ...
      case "insights":
        return (
          <div className="glass-panel p-6 w-80 h-80 overflow-y-auto">
            <h3 className="text-holographic text-lg mb-4 font-mono tracking-wider">
              <span className="animate-glow">AI INSIGHTS</span>
            </h3>
            <div className="space-y-4">
              <div className="hud-element p-4 border border-cyan-500/30 rounded-lg hover:border-cyan-400/50 transition-all duration-300">
      ...
      case "elevenlabs":
        return (
          <div className="glass-panel p-0 w-80 h-80 overflow-hidden border border-cyan-500/30">
            <div className="absolute top-0 left-0 right-0 h-8 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 flex items-center px-3">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse mr-2"></div>
      ...
      case "system":
        return (
          <div className="glass-panel p-6 w-80 h-80 overflow-y-auto">
            <h3 className="text-holographic text-lg mb-4 font-mono tracking-wider">
              <span className="animate-glow">SYSTEM STATUS</span>
            </h3>
      ...
      default:
        return (
          <div className="glass-panel p-6 w-80 h-80 overflow-y-auto">
            <h3 className="text-holographic text-lg mb-4 font-mono tracking-wider">
              <span className="animate-glow">LIVE TRANSCRIPTION</span>
            </h3>
            <div className="hud-element p-4 min-h-32 border border-cyan-500/30 rounded-lg">
              <div
                className="text-cyan-300 text-sm font-mono whitespace-pre-wrap"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="absolute w-[600px] h-[600px] rounded-full border border-cyan-500/20 animate-pulse"></div>
        <div
          className="absolute w-[550px] h-[550px] rounded-full border border-cyan-500/30 animate-pulse"
        ...
        <CircularHUD
          ...
          pulseEffect={true}
          className="z-10 shadow-2xl shadow-cyan-500/20"
        >
          {renderActivePanel()}
        </CircularHUD>
      ...
      <div className="absolute bottom-4 left-4 flex flex-col space-y-2">
        <div className="text-cyan-400/60 font-mono text-xs flex items-center">
          <div
