    ...
    <div className="space-y-4">
      ...
      <ScrollArea className="h-[calc(100vh-200px)] pr-4">
        <div className="space-y-4">
          ...
          {/* 3. PROPOSED FIX */}
          <StorySection title="Proposed Fix" icon={<Wrench />} iconColor="text-purple-400">
            <div className="space-y-4">
              {/* Confidence Meter */}
              <div className="space-y-2">
          ...
          <StorySection title="Impact Analysis" icon={<Layers />} iconColor="text-cyan-400">
            <div className="space-y-4">
              ...
              {/* Summary */}
              <div className="rounded-lg bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 p-4">
                ...
                <div className="space-y-4">
                  ...
                  {showRejectModal && (
                    <div className="mt-4 p-4 rounded-lg border border-red-500/20 bg-red-500/5">
                      <h4 className="text-sm font-light text-white mb-3">
                      ...
                      <textarea
                        ...
                        className="w-full h-20 px-3 py-2 text-sm bg-black/40 border border-white/10 rounded-lg resize-none focus:outline-none focus:border-purple-500/50"
                      />
