/**
 * CRITICAL FIX FOR TUESDAY DEMO
 * 
 * Run this SQL in your Supabase SQL Editor to fix the RAG system.
 * 
 * Problem: match_siam_vectors_gemini was querying siam_unified_vectors (empty table)
 * Solution: Update it to query siam_vectors (15,245 records with your AOMA data)
 */
...
BEGIN
  ...
  SELECT
    ...
    v.created_at,
    v.updated_at
  FROM siam_vectors v  -- FIXED: was siam_unified_vectors
  WHERE 
