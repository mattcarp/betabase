  ...
  try {
    ...
    for (const pageInfo of pages) {
      ...
      try {
        ...
        await fs.writeFile(
          path.join('tmp/aoma-crawled', `${safeName}_${timestamp}.html`),
          html
        );
        ...
        console.log(`   ✅ Success!`);
        console.log(`   📊 Found: ${extracted.headings.length} headings, ${extracted.buttons.length} buttons, ${extracted.links.length} links\n`);
