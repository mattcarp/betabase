...
async function runJiraExport() {
  ...
  try {
    ...
    const queries = [
      ...
      {
        project: "AOMA-2",
        jql: 'project = "AOMA-2" AND (created >= "2025-07-04" OR updated >= "2025-07-04") ORDER BY updated DESC',
      },
      {
        project: "AOMA-3",
        jql: 'project = "AOMA-3" AND (created >= "2025-07-04" OR updated >= "2025-07-04") ORDER BY updated DESC',
      },
      {
        project: "ITSM",
        jql: 'project = ITSM AND (created >= "2025-07-04" OR updated >= "2025-07-04") ORDER BY updated DESC',
      },
      {
        project: "UST",
    ...
    for (const query of queries) {
      ...
      console.log(
        `      3. Save as: tmp/jira-exports/${query.project.toLowerCase()}-tickets-since-2025-07-04.csv`
      );
      console.log("");
