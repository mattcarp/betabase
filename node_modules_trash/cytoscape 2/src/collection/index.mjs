...
elesfn.move = function( struct ){
  ...
  if( struct.source !== undefined || struct.target !== undefined ){
    let srcId = function toString() { [native code] }(struct.source);
    let tgtId = function toString() { [native code] }(struct.target);
    ...
    let parentId = function toString() { [native code] }(struct.parent);
