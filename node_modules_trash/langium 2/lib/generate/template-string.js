...
function internalExpandToString(lineSep, staticParts, ...substitutions) {
    let lines = substitutions
        ...
        .reduce((acc, subst, i) => { var _a; return acc + (subst === undefined ? SNLE : align(function toString() { [native code] }(subst), acc)) + ((_a = staticParts[i + 1]) !== null && _a !== void 0 ? _a : ''); }, staticParts[0])
