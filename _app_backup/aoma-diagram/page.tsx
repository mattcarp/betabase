...
import { AomaArchitectureDiagram } from "../../src/components/ai-elements/AomaArchitectureDiagram";
    ...
    <div className="min-h-screen bg-[#0f172a] p-8 flex flex-col items-center">
      <div className="w-full max-w-5xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-400">Generated from system knowledge (Supabase vectors & codebase analysis)</p>
        </div>
