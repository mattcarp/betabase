...
*   **Goal**: Demonstrate "Groovy" visual intelligence and multi-source recall.
*   **Key Features**:
    *   Mermaid diagrams with zoom/pan/export.
    *   Thought bubbles for reasoning.
    *   Inline citations.
    *   Voice UI visualization.
*   **Status**: ✅ Verified (Screenshot: `chat_interface`).

### 2. State-of-the-art Curate Tab 🧠
*   **Goal**: Showcase HITL (Human-in-the-Loop) knowledge curation.
*   **Key Features**:
    *   Feedback queue (thumbs/stars/text).
    *   Document relevance toggles.
    *   Accuracy metrics.
*   **Status**: ✅ Verified (Screenshot: `curate_tab_clicked`).

### 3. Automated Testing with HITL 🧪
*   **Goal**: Prove reliability through "thousands of seeded tests" and automated generation.
*   **Key Features**:
...
*   **Segments**:
    1.  **Intro & Chat**: "What is AOMA?" -> Diagram generation -> "Show me JIRA tickets".
...
*   All 3 pillars clearly demonstrated.
*   High production value (smooth cuts, clear audio, professional overlays).
*   "Wow" factor achieved through visual intelligence and seamless workflow.
