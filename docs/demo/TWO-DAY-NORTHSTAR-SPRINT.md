# Two-Day Northstar Demo Sprint
## Making All Three Pillars Demo-Ready

**Dates**: Day 1 + Day 2 (48 hours)
**Team**: Matt + Claude
**Goal**: Production-quality demo for all three pillars
...
## Day 1: Integration & Pillar 3 (Testing)

### Morning Session (4 hours)

#### Hour 1-2: Wire Up Test Dashboard Tabs
...
#### Hour 2-3: Enhance Self-Healing UI
...
#### Hour 3-4: Test Pillar Playwright Test
...
#### Hour 5-6: Pillar 2 - Curate Tab Integration
...
#### Hour 6-7: Feedback Impact Visualization (NEW)
...
#### Hour 7-8: Curate Pillar Playwright Test
...
- [ ] Take screenshots of each pillar
- [ ] Document any remaining issues

---

## Day 2: Pillar 1 (Chat) & Final Polish

### Morning Session (4 hours)

#### Hour 1-2: Chat Confidence Display
...
#### Hour 2-3: Source Attribution Enhancement
...
#### Hour 3-4: Before/After Demo Setup (Optional)
...
#### Hour 6-7: Polish & Error Handling
...
#### Hour 7-8: Final Smoke Test & Documentation
...
| `src/components/ai/BeforeAfterDemo.tsx` | New (optional) | Comparison component |
...
**Starting Point**: Verify dev server works and components render
...
**First Task**: Add Home and Self-Healing tabs to TestDashboard
