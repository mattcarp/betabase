...
**Demo Format**: ~5 minute recorded video for colleagues. Technical but casual. Edited in DaVinci Resolve with a vignette of Matt talking and text overlays for key points. No music, no fancy effects.
