...
const assistant = await openai.beta.assistants.retrieve("asst_VvOHL1c4S6YapYKun4mY29fM");
...
const vectorStore = await openai.beta.vectorStores.retrieve("vs_3dqHL3Wcmt1WrUof0qS4UQqo");
```
