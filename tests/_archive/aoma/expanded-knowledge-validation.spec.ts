...
test.describe("Expanded AOMA Knowledge Base Validation", () => {
  ...
  test("should answer questions about newly added AOMA features", async ({ page }) => {
    ...
    for (const testCase of EXPANDED_KNOWLEDGE_QUESTIONS) {
      ...
      console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
      console.log(
        `📝 [${totalQuestions}/${EXPANDED_KNOWLEDGE_QUESTIONS.length}] ${testCase.category}`
      );
      ...
      const hasUnknownPhrase = /don't know|not sure|unavailable|don't have|cannot find/i.test(
        cleanResponse
      );
