    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mac-body text-zinc-400">
            Browse and manage your recorded test sessions
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                className={cn(
                  viewMode === 'grid' ? 'mac-button-primary' : 'mac-button-outline'
                )}
              >
              ...
              <Button
                ...
                className={cn(
                  viewMode === 'list' ? 'mac-button-primary' : 'mac-button-outline'
                )}
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4 p-4 rounded-lg bg-zinc-900/50 border border-white/10">
              ...
              <div className="flex-1">
                ...
                <Select
                  ...
                  onValueChange={(value: string) => setSelectedStatus(value as SessionStatus | 'all')}
                >
                  <SelectTrigger className="mac-input">
        ...
        {filteredSessions.length === 0 && sessions.length === 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="mac-body text-zinc-500 mb-4">
